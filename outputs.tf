output "security_group_id" {
  value       = var.enable && var.sg ? aws_security_group.default[0].id : null
  description = "ID of the created security group."
}

output "security_group_arn" {
  value       = var.enable && var.sg ? aws_security_group.default[0].arn : null
  description = "ARN of the created security group."
}

output "security_group_name" {
  value       = var.enable && var.sg ? aws_security_group.default[0].name : null
  description = "Name of the created security group."
}

output "security_group_tags" {
  value       = var.enable && var.sg ? aws_security_group.default[0].tags : null
